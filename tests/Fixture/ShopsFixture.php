...
class ShopsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'taxes_included' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'tax_shipping' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'country_taxes' => ['type' => 'integer', 'length' => 1, 'null' => true],
        ...
        'eligible_for_payments' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'requires_extra_payments_agreement' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'password_enabled' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'has_storefont' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'eligible_for_card_reader_giveaway' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'finances' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'setup_required' => ['type' => 'integer', 'length' => 1, 'null' => true],
        'force_ssl' => ['type' => 'integer', 'length' => 1, 'null' => true],
        '_constraints' => [
